...
misha = game.Ally("Misha", "An ally")
misha.set_conversation("Hello! Welcome to the game. I wish you good luck!")
kitchen.set_character(misha)
...
while dead == False:
    ...
    if command in ["north", "south", "east", "west"]:
        ...
        if inhabitant is not None and not isinstance(inhabitant, game.Ally):
